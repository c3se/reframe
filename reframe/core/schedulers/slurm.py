...
class _SlurmNode(sched.Node):
    ...
    def satisfies(self, slurm_constraint):
        ...
        # but restrict our syntax to accept only AND or OR constraints and their
        # combinations; since Slurm features are not valid Python identifiers,
        # we replace them with booleans before evaluating
